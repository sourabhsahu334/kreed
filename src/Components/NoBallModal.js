...
const NoBallModal = () => {
    return (
        <View style={{ marginTop: '50%', marginHorizontal: 20, borderRadius: 10, backgroundColor: 'black', borderColor: '#A9F77F', borderWidth: 1 }}>
            <Text style={{ color: '#A9F77F', fontSize: 15, margin: 30, marginLeft: '38%', textAlign: 'center', borderColor: '#A9F77F', borderBottomWidth: 1, width: 80 }}>No Ball</Text>
            ...
            <TouchableOpacity style={[styles.Button,{marginTop:-1}]}>
