...
const MakecoHost = () => {
    ...
    return (
        <View style={{ marginTop: 'auto', backgroundColor: 'black', borderColor:'#A9F77F', borderTopWidth:1 }}>
            <Text style={{ color: '#A9F77F', fontSize: 18, margin: 20, }}>Make Co-Host</Text>
            ...
            <TouchableOpacity style={styles.StartGameButton} onPress={()=>navigation.navigate('ScoreBoarding')}>
